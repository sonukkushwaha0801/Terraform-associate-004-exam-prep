...
* Duration: 14-Day Intensive Study Plan
* Learning Approach:
...
Understand providers, resources, state management, and Terraform architecture.

### 3. Core Terraform Workflow

Master init, validate, fmt, plan, apply, and destroy workflows.

### 4. Terraform Configuration

Work with variables, outputs, data sources, expressions, functions, validations, dependencies, and sensitive data.
...
Understand workspaces, projects, governance, collaboration, integrations, and remote execution.
...
| 13  | Practice Questions + Mock Exam #1                        |
| 14  | Mock Exam #2 + Last Minute Revision                      |
...
```text
01-Infrastructure-as-Code-IaC-with-Terraform
...
Pass the Terraform Associate (004) certification while building production-relevant Terraform knowledge and a reusable study reference repository.
